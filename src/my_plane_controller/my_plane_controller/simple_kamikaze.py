...
from mavros_msgs.msg import Waypoint, State, ExtendedState, State
...
class KamikazeMissionControl(Node):
    def __init__(self):
        ...
        self.ext_state_sub = self.create_subscription(ExtendedState, "/mavros/extended_state", self.ext_state_cb, qos_profile_sensor_data)
...
# # # ***********************************************************************************************
    ...
    def build_search_mission(self):
        ...
        return [
            ...
            self.create_wp(-35.36471174, 149.16526144, alt, 16),
            self.create_wp(-35.36449597, 149.16525158, alt, 16),
...
if __name__ == '__main__':
    main()
            ...
            # self.create_wp(0.0, 0.0, 0.0, 20)   # RTL             